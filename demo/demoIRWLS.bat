...
..\windows\PIRWLS-train.exe -c 1000 -g 0.001 -t 1 ..\data\a9a ..\data\a9a.model		
...
..\windows\PIRWLS-train.exe -c 1000 -g 0.001 -t 2 ..\data\a9a ..\data\a9a.model			
...
..\windows\LIBIRWLS-predict.exe -l 1 -t 1 ..\data\a9a.t ..\data\a9a.model ..\data\a9a.output	
	
) ELSE (
ECHO ..\bin\PIRWLS-train.exe not found.
)
...
ECHO *******************************************************
ECHO  
..\windows\PSIRWLS-train.exe -c 1000 -s 75 -g 0.0001 -t 1 ..\data\a9a ..\data\a9a.model		
...
ECHO    
..\windows\PSIRWLS-train.exe -c 1000 -s 75 -g 0.0001 -t 2 ..\data\a9a ..\data\a9a.model			
