...
echo "*************************************************"
echo " "
${myDIR}/../bin/PIRWLS-train -c 1000 -g 0.001 -t 1 ${myDIR}/../data/a9a ${myDIR}/../data/a9a.model
...
echo "**************************************************"
echo " "
${myDIR}/../bin/PIRWLS-train -c 1000 -g 0.001 -t 2 ${myDIR}/../data/a9a ${myDIR}/../data/a9a.model
...
then
	...
	echo "*******************************************************"
	echo " "
	${myDIR}/../bin/PSIRWLS-train -c 1000 -g 0.0001 -s 75 -t 1 ${myDIR}/../data/a9a ${myDIR}/../data/a9a.model

	echo "********************************************************"
	echo "* RUNNING SEMIPARAMETRIC SVM (PSIRWLS) USING 2 THREADS *"
	echo "********************************************************"
	echo " "
	${myDIR}/../bin/PSIRWLS-train -c 1000 -g 0.0001 -s 75 -t 2 ${myDIR}/../data/a9a ${myDIR}/../data/a9a.model
